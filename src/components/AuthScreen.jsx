...
export default function AuthScreen({ onLogin }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#1c1b1f] flex flex-col items-center justify-center p-6 text-center">
      <div className="mb-8">
        <div className="w-20 h-20 bg-[#d0bcff] rounded-full flex items-center justify-center mx-auto mb-4">
          <i className="fas fa-wallet text-[#381e72] text-3xl"></i>
        </div>
      ...
      {!loading && (
        <button
          onClick={handleClick}
          className="w-full max-w-xs bg-white text-black font-medium py-4 rounded-full flex items-center justify-center gap-3 transition-all hover:bg-gray-100 shadow-lg"
        >
